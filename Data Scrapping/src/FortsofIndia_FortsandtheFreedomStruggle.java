...
public class FortsofIndia_FortsandtheFreedomStruggle {
	private WebDriver driver;
	  ...
	  driver.get("https://indianculture.gov.in/forts-of-india/forts-and-freedom-struggle");
	...
	//***********Getting list of Results (method 2 perfect)*************//
	  ...
	  public void Audiospage2subcat () throws InterruptedException {
		  ...
		  List<WebElement> subcategories = driver.findElements(By.xpath("//ul[@class='data-list nav fortfigt-tabs']/li"));
		  ...
		  {
			  Thread.sleep(500);
			  WebElement Title = subcat.findElement(By.tagName("a"));
