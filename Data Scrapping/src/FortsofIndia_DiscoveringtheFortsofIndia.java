...
public class FortsofIndia_DiscoveringtheFortsofIndia {
	private WebDriver driver;
	  ...
	  driver.get("https://indianculture.gov.in/forts-of-india/discovering-the-forts-of-india");
	...
	//***********Getting list of Results (method 2 perfect)*************//
	  ...
	  public void Audiospage2subcat () throws InterruptedException {
		  ...
		  for (int i = 1; i < liElements.size() - 1; i++) {
				...
				List<WebElement> subcatlist = subcatbox.findElements(By.xpath(".//div[@class='databox']"));
