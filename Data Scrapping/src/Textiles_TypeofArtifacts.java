...
public class Textiles_TypeofArtifacts {
	private WebDriver driver;
	  ...
	  driver.get("https://indianculture.gov.in/textiles-and-fabrics-of-india/type-of-artifacts");
...
//	  				  System.out.println(name.getText());
	  				...
	  				if (!paginationElements.isEmpty()) {
	  				  ...
	  				  for (int i = 0; i < liElements.size() - 3; i++) {
