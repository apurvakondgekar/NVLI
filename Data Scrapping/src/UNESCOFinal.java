...
public class UNESCOFinal {
	private WebDriver driver;
	  ...
	  driver.get("https://indianculture.gov.in/unesco");
	  ...
	  public void SubCategory () throws InterruptedException
	  {
		  ...
		  for (String h2Text : h2Texts) {
	         ...
	         // Perform actions on the element
	            ...
	            if (!h2Text.equals("Intangible Cultural Heritage"))
	        	   {
	        	   element.click();
...
//	  				  h2Texts.add(h2Text);
	           ...
	           {
	        	   System.out.println("Skipping Intangible Cultural Heritage");
	        	   continue;
	           }
