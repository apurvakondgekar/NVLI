...
public class HomePageComplete2 extends TestBase {
...
private WebDriver driver;
	...
	public void launch() throws MalformedURLException
	{
		...
		String gridURL = "http://10.129.155.98:4444";
		driver = initializeRemoteWebDriver(browserName, gridURL);
	...
	@Test (priority = 1)
	public void HomePage1Title() throws MalformedURLException
	{
	...
	@Test (priority = 2)
	public void HomePage2Search() throws InterruptedException, MalformedURLException
	{
		driver.get("https://indianculture.gov.in");
