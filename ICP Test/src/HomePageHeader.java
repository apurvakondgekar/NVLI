...
public class HomePageHeader {
	...
	public void HomePage2Search() throws InterruptedException
	{
		 ...
		 //Locating searchbox
		WebElement searchbox = driver.findElement(By.id("block-exposedformindian-culture-repositorypage-1"));
	     ...
	     // String result = searchResults.getText();
	        ...
	        WebElement searchInput2 = driver.findElement(By.id("edit-search-api-fulltext"));
	        searchInput2.sendKeys(keyword);
	        
	        List<WebElement> autosuggest = searchbox.findElements(By.tagName("li"));
	        for (WebElement option: autosuggest)
	        {
	        	if(option.getText().equalsIgnoreCase(keyword))
	        	{
	        		option.click();
	        	}
	        }
